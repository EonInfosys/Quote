<?php
namespace EonInfosys\Quote\Observer;
    ...
    public function execute(
        ...
        foreach ($quote->getAllItems() as $quoteItem) {
          ...
          $itemExtAttr = $quoteItem->getExtensionAttributes();
              if ($itemExtAttr === null) { $itemExtAttr = $this->extensionFactory->create();
           }
          $imageurl =$this->productImageHelper->create()->init($product, 'product_page_image_small')->setImageFile($product->getThumbnail())->resize(50, 50)->getUrl();
          $itemExtAttr->setImageUrl($imageurl); $quoteItem->setExtensionAttributes($itemExtAttr);
         }
         return;
       }
